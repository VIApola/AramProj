...
public class ImgFileDAO {
	...
	public int insert_img(ItemimgDTO dto) throws Exception{
		String sql = "insert into tbl_item_img values(?,?,?,?,?)";
		try(Connection con = bds.getConnection();
			PreparedStatement pstmt = con.prepareStatement(sql)	
				){
			pstmt.setInt(1, dto.getImg_no());
			pstmt.setInt(2, dto.getItem_no());
			pstmt.setString(3, dto.getImg_type());
			pstmt.setString(4, dto.getOri_name());
			pstmt.setString(5, dto.getSys_name());
