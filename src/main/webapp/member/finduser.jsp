                            ...
                            <div class="row findIdInput">
                                ...
                                <div class="row">
                                    <div class="col-12 d-flex justify-content-center">
                                        <button type="button" id="searchId" class="btn btn-secondary">아이디 찾기</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <form id="searchToForgotPwForm" action="/searchToForgotPw.user" method="get">
                            ...
                            <div class="row">
                                <div class="col d-flex justify-content-center">
                                    <button type="button" id="searchPw" class="btn btn-secondary">비밀번호 변경</button>
                                </div>
                            </div>
                        </form>
                    </div>
