...
<!--style영역-->
<link
	href="${pageContext.request.contextPath}/resources/css/kakaojoin.css"
			...
			<form id="signupForm" action="/kakaoSignupProc.user" method="post">
				...
				<div class="signupInputBox">
					...
					<div class="row clsInputRow">
						...
						<div class="col-9 col-lg-3 p-1">
							<input type="text" class="form-control" id="name" name="name"
								value="${kakaoname}" readonly>
						</div>
					</div>
