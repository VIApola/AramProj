...
<script>
	...
	$("#rowPrice").on("click",function(){
	  $.ajax({
		url:"/nameRowPrice.item?searchKeyword=${searchKeyword}"
	   ,type:"get"
	...
	$("#highPrice").on("click",function(){
	  $.ajax({
		url:"/nameHighPrice.item?searchKeyword=${searchKeyword}"
	   ,type:"get"
	   ,success:function(data){
		   selectPriceAndName(data);
	   }
	...
	$("#itemName").on("click",function(){
	  $.ajax({
		url:"/nameSearchName.item?searchKeyword=${searchKeyword}"
	   ,type:"get"
	   ,success:function(data){
		   selectPriceAndName(data);
	   }
