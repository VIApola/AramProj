...
<script>
	...
	$("#rowPrice").on("click",function(){
	  $.ajax({
		url:"/priceRowPrice.item?minPrice=${minPrice}&maxPrice=${maxPrice}"
	   ,type:"get"
	...
	$("#highPrice").on("click",function(){
	  $.ajax({
		url:"/priceHighPrice.item?minPrice=${minPrice}&maxPrice=${maxPrice}"
	   ,type:"get"
	   ,success:function(data){
		   selectPriceAndName(data);
	   }
	...
	$("#itemName").on("click",function(){
	  $.ajax({
		url:"/priceName.item?minPrice=${minPrice}&maxPrice=${maxPrice}"
	   ,type:"get"
	   ,success:function(data){
		   selectPriceAndName(data);
	   }
